...
func (state *State) AnalyseFunction(function *palisade.Ident) (f *Function) {
...
func (state *State) AnalyseFnDef(statement *palisade.FnDef) {
...
func (state *State) AnalyseFnDecl(statement *palisade.FnSig) {
